...
- **Most recent (main):** FR-075 (Cost Circuit-Breaker — per-SKU daily Google API budget + admin kill-switch) — **merged (PR #45, squash).** The FR-064-deferred spend cap; first Hardening-Track item after Stage 0 (FR-064) and Track A1. See the session-4 hand-off above + `feature-requests/FR-075-cost-circuit-breaker/`. Full suite 1,649 / 87. *(Prior: FR-074 Census ACS vintage resilience — A1 finale, PR #44.)*
