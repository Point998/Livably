...
- **FR-062 (FCC broadband repair): 📋 SPEC'd (not built)** — restore live internet data via the official FCC Broadband Data Collection (BDC) API after the old keyless map API was retired. Direction chosen: official BDC API. See `feature-requests/FR-062-fcc-broadband-repair/`.
